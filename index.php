                                ...
                                <div class="container" class="divScroll" style="overflow-y:scroll;height:360px;width:600px;">
                                    ...
                                    <table class="table table-hover" style="border: 1px solid black;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($DbMngpost->getPost()  as $comments) : ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="container">
                                                            ...
                                                            <div class="row" style="font-weight: 600; color:chocolate">
                                                                <div class="col-10"><?= $comments->getTitle() ?></div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-3"><img src="<?= $comments->getImage() ?>" alt="my_img" width="120px" height="90px"></div>
                                                                <div class="col-9"><?= $comments->getBody() ?></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- <td><img src="<?= $comments->getImage() ?>" alt="my_img" width="50px" height="35px"></td>
                                                    <td><?= $comments->getUsername() ?></td>
                                                    <td><?= $comments->getBody() ?></td> -->
