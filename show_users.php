                ...
                <div class="col-12  col-lg-8 ">
                    <div class="card cards card-2 text-center" id="card2">
                        <div class="card-body">
                            ...
                            <div class="container">
                                <h4 style="border-bottom: 2px solid #999;">Click on Users to see more details</h4>
                                ...
                                <ul>
                                    ...
                                    foreach ($DbMngIndex->getAllUser()  as $member) {


                                        echo '<li style="margin-top:3%"><a href="user_card.php?subject=' . $member->getUserName() . ' "class="button" title=""  style="color: darkgreen;font-size:120% ;font-weight: 600" >' . $member->getFirstName() . " " . $member->getLastName() . '</a></li>';
                                    }
