...
<!-- to update user info -->
<?php
if (isset($_SESSION['this_user_update_new']) && $_SESSION['this_user_update_new'] == "1") {
    //unset($_SESSION['this_user_login_new']);
    $showu = "none";
    $showup = "block";
}
...
?>
<!-- to show error update -->
<?php
if (isset($_SESSION['error_statup']) && $_SESSION['error_statup'] == "1") {
    unset($_SESSION['error_statup']);
    $showupe = "block";
}
?>
...
<body>
                    ...
                    <div class="card cards card-2 text-center" id="card2">
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning" role="alert" style="display:<?php echo isset($showu) ? $showu : "block"; ?>">
                                Log in to see your Info and Update it!
                            </div>

                            <!------------------------------------ user's info update  part------------------------------- -->

                            <!-- show there is error -->
                            <div class="alert alert-danger" role="alert" style="display:<?php echo isset($showupe) ? $showupe : "none"; ?>">
                                <?php echo isset($_SESSION['msg_errorup']) ? $_SESSION['msg_errorup'] : ""; ?>
                            </div>

                            <div class="container" style="display:<?php echo isset($showup) ? $showup : "none"; ?>">

                                <!-- show there is error -->
                                <div class="alert alert-danger" role="alert" style="display:<?php echo isset($showupe) ? $showupe : "none"; ?>">
                                    <?php echo isset($_SESSION['msg_errorup']) ? $_SESSION['msg_errorup'] : ""; ?>
                                </div>
                                <!-- add form to show users info  -->
                                <form action="controller/control.php" method="POST" id="form_update" enctype="multipart/form-data">
                                    ...
                                    <div class="form-check" style="text-align: left;">
                                        <input class="form-check-input" type="radio" name="G1" id="female" value="Female" <?php echo ($_SESSION['this_user_gender_new'] == "female" ? 'checked' : ''); ?> />

                                        <label class="form-check-label" for="female"> Female </label>
                                    </div>
                                    <div class="form-check" style="text-align: left;">
                                        <input class="form-check-input" type="radio" name="G1" id="male" value="Male" <?php echo ($_SESSION['this_user_gender_new'] == "male" ? 'checked' : ''); ?> />
                                        <label class="form-check-label" for="male"> Male </label>
                                    </div>
                                    <div><span id="radiospan" style="color:chocolate"><?php echo isset($_SESSION['mygendererror1']) ? $_SESSION['mygendererror1'] : ""; ?></span></div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="username1" class="form-control" id="username1" value="<?php echo $_SESSION['this_user_username_new'] ?>" disabled>
                                        <!-- show js error -->
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="firstname1" class="form-control" id="firstname1" value="<?php echo $_SESSION['this_user_fname_new'] ?>">
                                        <!-- show js error -->
                                        <span></span>
                                        <!-- error text to show -->
                                        <span style="color:chocolate;font-size:90%;text-align:left"><?php echo isset($_SESSION['myfirsterror1']) ? $_SESSION['myfirsterror1'] : ""; ?></span>
                                    </div>

                                    <div class="form-group mb-3">

                                        <input type="text" name="lastname1" class="form-control" id="lastname1" value="<?php echo $_SESSION['this_user_lname_new'] ?>">
                                        <!-- show js error -->
                                        <span></span>
                                        <!-- error text to show -->
                                        <span style="color:chocolate;font-size:90%;text-align:left"><?php echo isset($_SESSION['mylasterror1']) ? $_SESSION['mylasterror1'] : ""; ?></span>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="email1" class="form-control" id="email1" value="<?php echo $_SESSION['this_user_email_new'] ?>">
                                        <!-- show js error -->
                                        <span></span>
                                        <!-- error text to show -->
                                ...
                                <!-- add modal for change the password -->
                                <a href="#" class="btn btn-success" id="passChange" data-bs-toggle="modal" data-bs-target="#passModal">Change Password</a>
    ...
    <!-- give modal to the change password -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="form_edit_pass" method="POST" action="controller/control.php">

                        <!-- hidden input -->
                        <input type="hidden" name="action" value="passchange">

                        <input name="old_pass" type="text" class="form-control" id="old_pass" placeholder="Old password" />
                        <!-- error -->
                        <span style="color:chocolate"></span>


                        <input name="new_pass" type="text" class="form-control" id="new_pass" placeholder="New Password" style="margin-top: 2%;" />
                        <!-- error -->
                        <span style="color:chocolate"><?php echo isset($_SESSION['newpasserror']) ? $_SESSION['newpasserror'] : ""; ?></span>

                        <input name="conform_new_pass" type="text" class="form-control" id="conform_new_pass" placeholder="Password(Confirmation)" style="margin-top: 2%;" />
                        <!-- error -->
                        <span style="color:chocolate"><?php echo isset($_SESSION['newcpasserror']) ? $_SESSION['newcpasserror'] : ""; ?></span>
                        <span style="color:chocolate"><?php echo isset($_SESSION['newrerror']) ? $_SESSION['newrerror'] : ""; ?></span>

                        <input type="submit" name="submit_change" id="submit_change" value="Save change" class="btn btn-warning mystyle2" style="display: block;margin-top:3%" />
                    </form>
                </div>
